package edmt.dev.androidinstagramfilter.Adapter;
...
import edmt.dev.androidinstagramfilter.FiltersListFragment;
import edmt.dev.androidinstagramfilter.Interface.FiltersListFragmentListener;
import edmt.dev.androidinstagramfilter.R;
...
public class ThumbnailAdapter extends RecyclerView.Adapter<ThumbnailAdapter.MyViewHolder> {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(context).inflate(R.layout.thumnail_item,parent,false);
